...
def process_datasets():
    ...
    # Load the datasets
    geocoded_data = pd.read_csv('../data/processed/final/geocoded_secondary_locations.csv')
    secondary_data = pd.read_csv('../data/processed/final/secondary_education_locations.csv')
    ...
    print("\nPreparing secondary education dataset...")
    secondary_data['postcode_cleaned'] = secondary_data['POSTCODE_VEST'].apply(clean_postcode)
    secondary_data['house_number'] = secondary_data['full_address'].apply(extract_house_number)
    ...
    output_path = '../data/processed/final/cleaned_secondary_locations_for_qgis.csv'
