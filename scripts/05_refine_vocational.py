...
def process_datasets():
    ...
    # Load the datasets
    geocoded_data = pd.read_csv('../data/processed/final/geocoded_vocational_locations.csv')
    vocational_data = pd.read_csv('../data/processed/final/vocational_education_locations.csv')
    ...
    print("\nPreparing vocational dataset...")
    vocational_data['postcode_cleaned'] = vocational_data['POSTCODE_VEST'].apply(clean_postcode)
    vocational_data['house_number'] = vocational_data['full_address'].apply(extract_house_number)
    ...
    output_path = '../data/processed/final/cleaned_vocational_locations_for_qgis.csv'
