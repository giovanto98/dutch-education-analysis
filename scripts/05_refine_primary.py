...
def process_datasets():
    ...
    # Load the datasets
    geocoded_data = pd.read_csv('../data/processed/final/geocoded_primary_locations.csv')
    primary_data = pd.read_csv('../data/processed/final/primary_education_locations.csv')
    ...
    print("\nPreparing primary education dataset...")
    primary_data['postcode_cleaned'] = primary_data['POSTCODE_VEST'].apply(clean_postcode)
    primary_data['house_number'] = primary_data['full_address'].apply(extract_house_number)
    ...
    output_path = '../data/processed/final/cleaned_primary_locations_for_qgis.csv'
